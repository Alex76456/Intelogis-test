...
export const fetchDeliveryPointsSuccess = (payload: FetchDeliveryPointsSuccessPayload): FetchDeliveryPointsSuccess => ({
  type: FETCH_DELIVERYPOINTS_SUCCESS,
  payload: payload,
})

export const fetchDeliveryPointsFailure = (payload: FetchDeliveryPointsFailurePayload): FetchDeliveryPointsFailure => ({
