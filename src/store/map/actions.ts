...
export const fetchPositionsSuccess = (payload: FetchPositionsSuccessPayload): FetchPositionsSuccess => ({
  type: FETCH_POSITIONS_SUCCESS,
  payload,
})

export const fetchPositionsFailure = (payload: FetchPositionsFailurePayload): FetchPositionsFailure => ({
